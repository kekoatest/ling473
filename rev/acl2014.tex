...
\title{Review of text Summarization Paper}
...
Source: http://aclweb.org/anthology/P/P17/
...
\item Note: this should be a summary and not a direct copy of the text of the paper. You can copy figures and tables from the paper.
\end{itemize}
...
\begin{itemize}
\item Did the authors explain the problem and review the prior work or the state-of-the-art techniques for the problem?
\item Do the experimental results convincingly demonstrate the benefit of the approach? (e.g. have the authors used a reasonably strong baseline and fair experimental conditions).
\item What are the limitations of the approach? (e.g. will it work on other languages and in other settings (more or less data, availability of annotated resources, constraints on running time or memory consumption))
\item Are there other possible applications of the approach (e.g. can we address other phenomena using a similar approach)?
\item What are possible directions for future work building on this approach or addressing the same problem in a better way?
\end{itemize}
...
Your review should have an abstract and be at least two pages according to the ACL template. Cite the paper you are reviewing, plus any other papers you mention, in a References section.

\section{Introduction}

{\em International Joint Conference on Artificial
  Intelligence}.
